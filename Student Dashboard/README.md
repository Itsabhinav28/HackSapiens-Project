# [व्यवसाय-NidhiReact](http://demos.creative-tim.com/material-dashboard-react/#/dashboard?ref=readme-mdr) [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social&logo=twitter)](https://twitter.com/intent/tweet?url=JAATproduct/material-dashboard-react&text=Check%20Material%20Dashboard%202%20react%20made%20by%20@CreativeTim%20#webdesign%20#dashboard%20#materialdesign%20#react%20JAATproduct/material-dashboard-react)
...
व्यवसाय-NidhiReact is our newest free MUI Admin Template based on React. If you’re a developer looking to create an admin dashboard that is developer-friendly, rich with features, and highly customisable, here is your match. Our innovative MUI & React dashboard comes with a beautiful design inspired by Google's Material Design and it will help you create stunning websites & web apps to delight your clients.

**Fully Coded Elements**
व्यवसाय-NidhiReact is built with over 70 frontend individual elements, like buttons, inputs, navbars, nav tabs, cards, or alerts, giving you the freedom of choosing and combining. All components can take variations in color, which you can easily modify using MUI styled() API and sx prop. You will save a lot of time going from prototyping to full-functional code because all elements are implemented.
...
You can read more about the [documentation here](JAATlearning-lab/react/overview/material-dashboard/).
...
[<img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/logos/react-logo.png?raw=true" width="60" height="60" />](JAATproduct/material-dashboard-react?ref=readme-mdr)
...
- Download from [RAM](JAATproduct/material-dashboard-react?ref=readme-mdr).
...
The documentation for the Material Dashboard is hosted at our [website](JAATlearning-lab/react/overview/material-dashboard/?ref=readme-mdr).
...
- [Download Page](JAATproduct/material-dashboard-react?ref=readme-mdr)
- Documentation is [here](JAATlearning-lab/react/overview/material-dashboard/?ref=readme-mdr)
- [License Agreement](JAATlicense?ref=readme-mdr)
- [Support](JAATcontact-us?ref=readme-mdr)
...
1. Make sure that you are using the latest version of the Material Dashboard React. Check the CHANGELOG from your dashboard on our [website](JAATproduct/material-dashboard-react?ref=readme-mdr).
2. Providing us reproducible steps for the issue will shorten the time it takes for it to be fixed.
3. Some issues may be browser specific, so specifying in what browser you encountered the issue might help.

## Technical Support or Questions

If you have questions or need help integrating the product please [contact us](JAATcontact-us?ref=readme-mdr) instead of opening an issue.

## Licensing

- Copyright 2023 [RAM](https://www.creative-tim.com?ref=readme-mdr)
- RAM [license](JAATlicense?ref=readme-mdr)

## Useful Links

- [More products](JAATtemplates?ref=readme-mdr) from RAM

- [Tutorials](https://www.youtube.com/channel/UCVyTG4sCw-rOvB9oHkzZD1w)

- [Freebies](JAATbootstrap-themes/free?ref=readme-mdr) from RAM

- [Affiliate Program](JAATaffiliates/new?ref=readme-mdr) (earn money)
